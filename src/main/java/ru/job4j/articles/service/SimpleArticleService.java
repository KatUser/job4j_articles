...
public class SimpleArticleService implements ArticleService {
    ...
    public void generate(Store<Word> wordStore, int count, Store<Article> articleStore) {
        ...
        /* сначала генерятся статьи, потом уже сохраняются java.lang.OutOfMemoryError: Java heap space

        var articles = IntStream.iterate(1, i -> i <= count, i -> i + 1)
        ...
        */
        /* Теперь article сохраняется после создания */
